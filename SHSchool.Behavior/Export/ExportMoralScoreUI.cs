...
{
    public partial class ExportMoralScoreUI : FISCA.Presentation.Controls.BaseForm, SmartSchool.API.PlugIn.Export.ExportWizard
    {
        ...
        public ExportMoralScoreUI(string title, Image img)
        {
            InitializeComponent();
